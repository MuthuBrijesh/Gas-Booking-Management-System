<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aboutus.aspx.cs" Inherits="Try2.Aboutus" %>
...
<body id="body1">
    ...
    <asp:HyperLink ID="hyper1" runat="server" NavigateUrl="~/CustomerHome.aspx" color="Red"
        ...
        <asp:HyperLink ID="hyper4" runat="server" NavigateUrl="~/Complaint.aspx" color="Red"
