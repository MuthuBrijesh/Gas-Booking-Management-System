<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignup.aspx.cs" Inherits="Try2.AdminSignup" %>
...
<body id="body1">
    ...
    <p id="P1" name="S1"> Admin Signup </p>
    <asp:TextBox ID="TextBox1" runat="server" type="text" placeholder="Name"></asp:TextBox>
    <asp:TextBox ID="TextBox2" runat="server" type="text" placeholder="Phone Number"></asp:TextBox>
    ...
    <asp:HyperLink ID="hyper1" runat="server" NavigateUrl="~/AdminLogin.aspx">Login Here</asp:HyperLink>
    ...
    <asp:Image ID="Image7" runat="server" ImageUrl="~/icons8-edit-account-50.png" 
        ...
        style="z-index: 1; left: 750px; top: 344px; position: absolute; height: 29px; width: 32px; bottom: 316px" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/icons8-edit-account-50.png" 
        
        
        style="z-index: 1; left: 750px; top: 275px; position: absolute; height: 29px; width: 32px; bottom: 385px" />
        <asp:Image ID="Image3" runat="server" ImageUrl="~/icons8-lock-50.png" 
        
        
        
        style="z-index: 1; left: 750px; top: 483px; position: absolute; height: 29px; width: 32px; bottom: 177px" />
        <asp:Image ID="Image4" runat="server" ImageUrl="~/icons8-lock-50.png" 
        
        
        
        style="z-index: 1; left: 746px; position: absolute; height: 29px; width: 32px; top: 416px;" />
    <p id="p6">United Gas Booking</p>

    <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ControlToCompare="TextBox3" ControlToValidate="TextBox4" 
        ErrorMessage="Password Mismatch" 
        style="z-index: 1; left: 1060px; top: 421px; position: absolute"></asp:CompareValidator>
    <asp:Label ID="Label5" runat="server" 
        style="z-index: 1; left: 1070px; top: 487px; position: absolute"></asp:Label>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
        ControlToValidate="TextBox2" ErrorMessage="Enter Valid Mobile" 
        style="z-index: 1; left: 1060px; top: 351px; position: absolute" 
        ValidationExpression="^[0-9]{10}$"></asp:RegularExpressionValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
        ControlToValidate="TextBox1" ErrorMessage="Enter Valid Name" 
        style="z-index: 1; left: 1063px; top: 281px; position: absolute" 
