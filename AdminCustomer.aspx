<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCustomer.aspx.cs" Inherits="Try2.AdminCustomer" %>
...
<body id="body1">
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" 
            style="z-index: 1; left: 111px; top: 163px; position: absolute; height: 133px; width: 187px">
